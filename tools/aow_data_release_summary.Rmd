...
summ_df <- denom |> filter(recruitment_era != "2021-22") |>
  group_by(aow_person_id) |>
  summarise(across(c(has_data, has_survey, has_measure, has_bloods, has_ckcog), ~max(.))) |>
  ungroup() |>
  unique() |>
  summarise(total = n(),
            across(c(has_data, has_survey, has_measure, has_bloods, has_ckcog), ~sum(.))) |>
...
summ_df_bib <- denom |> filter(is_bib == "BiB") |> filter(recruitment_era != "2021-22") |>
  summarise(total = n(),
            across(c(has_data, has_survey, has_measure, has_bloods, has_ckcog), ~sum(.))) |>
  ungroup() |>
  relocate(has_data, .after = total)
...
summ_df <- denom |>  filter(recruitment_era != "2021-22") |> group_by(year_group) |>
  summarise(total = n(),
            across(c(has_data, has_survey, has_measure, has_bloods, has_ckcog), ~sum(.))) |>
  ungroup() |>
...
summ_df <- denom |>  filter(recruitment_era != "2021-22") |> group_by(recruitment_era) |>
  summarise(total = n(),
            across(c(has_data, has_survey, has_measure, has_bloods, has_ckcog), ~sum(.))) |>
  ungroup() |>
...
summ_df <- denom |>  filter(recruitment_era != "2021-22") |> group_by(recruitment_era, year_group) |>
  summarise(total = n(),
            across(c(has_data, has_survey, has_measure, has_bloods, has_ckcog), ~sum(.))) |>
  ungroup() |>
  mutate(year_group = as.integer(year_group)) |>
