...
aow_miss_label <- function(type) {
  ...
  lab <- case_when(type == "added_2" ~ c("Added in version 2" = -1),
                   ...
                   type == "added_20" ~ c("Added in version 20" = -1),
                   type == "added_21" ~ c("Added in version 21" = -1),
                   type == "added_30" ~ c("Added in version 30" = -1),
                   ...
                   type == "revised_20" ~ c("Revised in version 20" = -2),
                   type == "revised_21" ~ c("Revised in version 21" = -2),
                   type == "revised_30" ~ c("Revised in version 30" = -2),
                   ...
                   type == "removed_20" ~ c("Removed in version 20" = -3),
                   type == "removed_21" ~ c("Removed in version 21" = -3),
                   type == "removed_30" ~ c("Removed in version 30" = -3),
