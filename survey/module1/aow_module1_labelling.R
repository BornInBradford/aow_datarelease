...
module <- module %>%
  set_variable_labels(aow_recruitment_id = "Age of Wonder recruitment ID",
                      ...
                      fas_total = "Family Affluence Scale (FAS) (higher = more affluent)",
                      ...
                      own_fin_total = "Own Financial Resources (higher = more sources)",
                      ...
                      sais_total = "Striving to Avoid Inferiority Scale (higher = greater inferiority avoidance)",
                      ...
                      awb3_4_talent_in_arts___4 = "Agree I have great talent in artistic activities",
                      awb3_4_talent_in_arts___5 = "Strongly agree I have great talent in artistic activities",
