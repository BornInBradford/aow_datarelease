...
min_online_version <- min(online$mod2_version, na.rm = TRUE)
max_online_version <- max(online$mod2_version, na.rm = TRUE)
min_offline_version <- min(offline$mod2_version, na.rm = TRUE)
