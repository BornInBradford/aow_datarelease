# Module 3 survey administrative variables

source("tools/aow_survey_functions.R")

mod_allcols <- readRDS("U:/Born In Bradford - Confidential/Data/BiB/processing/AoW/survey/data/aow_survey_module3_merged.rds")
...
mod_allcols <- mod_allcols |> inner_join(denom, by = "aow_recruitment_id") |>
  mutate(survey_date = coalesce(date_time_collection, module_3_timestamp) |> as.Date(),
...
# export
saveRDS(mod_select, "U:/Born In Bradford - Confidential/Data/BiB/processing/AoW/survey/data/aow_survey_module3_linked.rds")
saveRDS(data_not_in_denom, "U:/Born In Bradford - Confidential/Data/BiB/processing/AoW/survey/data/aow_survey_module3_notlinked.rds")
