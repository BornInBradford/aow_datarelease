...
module <- module %>%
  set_variable_labels(aow_recruitment_id = "Age of Wonder recruitment ID",
                      ...
                      patt_career = "Pupils attitudes toward technology (higher = more likely to choose tech job)",
                      patt_interest = "Pupils attitudes toward technology (higher = finds tech more interesting)",
                      patt_tedious = "Pupils attitudes toward technology (higher = finds tech more tedious)",
                      patt_conseq = "Pupils attitudes toward technology (higher = more positive consequences)",
                      patt_diff = "Pupils attitudes toward technology (higher = tech more difficult)",
                      patt_gender = "Pupils attitudes toward technology (higher = tech is for both boys and girls)",
