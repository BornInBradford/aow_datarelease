# Module 24 survey online/offline merge and tidy up

source("tools/aow_survey_functions.R")

redcap_project_name <- c("aow_module_24_online_survey", "aow_module_24_offline_survey")

# data
online <- read_dta("U:\\Born in Bradford - AOW Raw Data\\redcap\\surveys\\data\\Survey_Module24_Online.dta")
offline <- read_dta("U:\\Born in Bradford - AOW Raw Data\\redcap\\surveys\\data\\Survey_Module24_Offline.dta")
...
# export
saveRDS(mod_allcols, "U:/Born In Bradford - Confidential/Data/BiB/processing/AoW/survey/data/aow_survey_module24_merged.rds")
